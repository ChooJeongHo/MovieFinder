...
| Test | JUnit 4, MockK 1.14.9, Turbine 1.2.1 (161개 유닛 + 5개 Espresso) |
...
- 7개 MaterialCardView 카드 UI (기본 4개 + 목표 달성률 + 파이차트 + 바차트)
...
총 **161개** 유닛 테스트 + **5개** Espresso UI 테스트를 작성하여 핵심 비즈니스 로직을 검증합니다.
